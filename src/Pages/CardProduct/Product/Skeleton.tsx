...
const MyLoader = (props) => (
  ...
  >
    ...
    <rect x="91" y="440" rx="10" ry="10" width="75" height="75" />
    <rect x="186" y="440" rx="10" ry="10" width="75" height="75" />
    <rect x="281" y="440" rx="10" ry="10" width="75" height="75" />
    <rect x="376" y="440" rx="10" ry="10" width="75" height="75" />
